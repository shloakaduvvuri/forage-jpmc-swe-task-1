...
class ClientTest(unittest.TestCase):
  ...
  def test_getRatio(self):
    ...
    self.assertEqual(getRatio(quotes[0]['top_ask']['price'], quotes[1]['top_ask']['price']), 121.2 / 121.68)
  ...
  def test_getRatio_priceBIsZero(self):
    ...
    self.assertEqual(getRatio(quotes[0]['top_ask']['price'], quotes[1]['top_ask']['price']), None)
